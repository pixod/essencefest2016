...
<a href="drjuanitabynum.php">Dr. Juanita Bynum<BR></a></h2>
</td>
...
<img src="emfArtists/akeys.jpg">
<h2><span id="hd">Corey J. Hebert, MD<BR>A Leader in Community-Inspired Medicine</span>
<BR>Dr. Corey Hebert is a practicing physician, television and radio talk show host, motivational speaker and a leader in improving the health of the citizens of New Orleans, especially the youth. After graduating from Meharry Medical College in Nashville, Tennessee, Dr. Corey realized his passion was to serve the under-represented populations of America. During his residency at Tulane University Medical Center in New Orleans he earned the position of Chief Resident of Pediatrics, the first African-American in the institution's history to achieve this honor. His expertise led him to create an informative TV show about pediatric health concerns in the inner city called "Urban Pediatrics" which is still a popular show in New Orleans. Since Hurricane Katrina, Dr. Corey has appeared on many national TV shows, included "Oprah" and is also featured in Spike Lee's film "When the Levees Broke." 
</h2><BR>
<center>
...
<td valign="top"><img src="shim.gif" width="8" height="400" align="left">

<object width="330" height="600"><param name="FlashVars" value="one=Flickr&two=2" /><param name="movie" value="emfHomeGallery.swf"></param><param name="allowFullScreen" value="true"></param><param name="wmode" value="transparent"></param><param name="allowscriptaccess" value="always"></param><embed  FlashVars="one=Flickr&two=2"  src="emfHomeGallery.swf" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="330" height="600" wmode="transparent"></embed></object><BR><center><h2><a href="photos.php">SEE THE ENTIRE EMF PHOTO GALLERY</a></h2></center><BR><center><h2><a href="photos.php">SEE THE ENTIRE EMF PHOTO GALLERY</a></h2></center>
