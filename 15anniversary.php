...
<head>
<meta property="og:title" content="Essence Music Festival 2010- Trey Sonyz Twitter Promotion">
<meta property="og:site_name" content="Essence Music Festival 2010">
<meta property="og:image" content="http://www.essencemusicfestival.com/treysongzpromotion/PromoTreySongz.jpg">

<title>Essence Music Festival 2010 | 15 Anniversary Twitter Promotion</title>
<style type="text/css">
...
.margin-top-neg-25{ margin-top:-15px;}
...
.promobox{ background:transparent url('takeoverMusicWorld/background.jpg') no-repeat scroll left top;  margin:10px auto 0px auto; padding:17px 18px 0px 18px; width:976px; height:471px; color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:14px;}
.promobox a{ color:#ffffff; text-decoration:none; font-weight:bold;}
.promobox a:hover{ text-decoration:underline;}

.promobox a.bitly{ color:#000000;}

#showrules{ background:transparent url('takeoverMusicWorld/officiallink.gif') no-repeat scroll left top; display:block; width:146px; height:25px; color:#ffffff; font-size:12px; padding-top:5px; padding-left:15px; margin-left:65px; text-decoration:none;}
...
<td valign="top">
	<div class="promobox">		
		<div class="right wid-600" style="padding-top:155px; padding-right:10px;">			
			<div style="text-align:left; height:230px;">
			Check out the new Essence Music Twitter Promotion featuring some of the hottest music superstars.  For 5 lucky winners, Essence Music Festival and Music World is giving away a special limited number of CD/DVD for your listening pleasure . People, the only catch in order to win, is that you have to spread the word, social media networking style.
			<br/><br/>
			To enter for a chance to win, all you need is a Twitter account and a willingness to re-tweet. First, follow <a href="http://twitter.com/essencemusic">@essencemusic.</a> Then, keep an eye out for the following tweet: “For a chance 2 win an exclusive collectors CD/DVD from EMF &amp; Music World RT. #EMF2010 <a href="http://bit.ly/emf15th">http://bit.ly/emf15th</a>". Once you see that, simply re-tweet it and you're all set. Simple, right?
			<br/><br/>
			The sweepstakes starts today at 12pm EST, June 28 2010 and will run through at 12pm EST June 29 ending. The winners will be announced at the essencemusic twitter feed and posted on the EMF website. Good Luck!
			</div>			
		</div>
		<div class="clearout"></div>
		
		<div class="left wid-950" style="padding-right:10px;">
			<div class="left margin-top-neg-25" style="padding-left:5px;"><a href="http://www.musicworldent.com/" target="_blank"><img src="takeoverMusicWorld/musicWorld_logo.png" alt="Mary J Blige Logo" border="0"></a></div>
			
			<div class="right pad-top-30" style="margin-right:15px;"><a href="http://www.facebook.com/pages/Essence-Online/68771922854#!/pages/ESSENCE-Music-Festival/42125257610?ref=sgm" target="_blank"><img src="takeoverMusicWorld/facebook-icon.png" alt="facebook" border="0"></a></div>
			<div class="right pad-top-30" style="margin-right:10px;"><a href="http://twitter.com/essencemusic" target="_blank"><img src="takeoverMusicWorld/twitter-icon.png" alt="twitter" border="0"></a></div>
			<div class="right pad-top-30" ><script type="text/javascript" src="http://w.sharethis.com/button/sharethis.js#publisher=a51b179e-fe3a-4fda-85af-e436cbc4cd97&amp;type=website&amp;style=horizontal&amp;post_services=email%2Cfacebook%2Ctwitter%2Cgbuzz%2Cmyspace%2Cdigg%2Csms%2Cwindows_live%2Cdelicious%2Cstumbleupon%2Creddit%2Cgoogle_bmarks%2Clinkedin%2Cbebo%2Cybuzz%2Cblogger%2Cyahoo_bmarks%2Cmixx%2Ctechnorati%2Cfriendfeed%2Cpropeller%2Cwordpress%2Cnewsvine"></script></div>
			<div class="right pad-top-30" style="margin-right:5px;"><iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.essencemusicfestival.com%2F15anniversary.php&amp;layout=button_count&amp;show_faces=true&amp;width=100&amp;action=like&amp;font=arial&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px;" allowTransparency="true"></iframe></div>				
		</div>
	</div>
	<div class="clearout"></div>
	<a href="15anniversary_rules.php" title="Official Rules" id="showrules" class="left" target="_blank"><strong>The Official Rules &gt;</strong></a>
</td>
</tr>
