...
<title>Essence Music Festival 2010 | Mary J. Blige Twitter Promotion</title>
<style type="text/css">
...
.promobox{ background:transparent url('takeoverMJB/EMF_PromoPage_MJB_bg2.gif') no-repeat scroll left top;  margin:10px auto 0px auto; padding:17px 18px 0px 18px; width:976px; height:471px; color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:14px;}
...
#showrules{ background:transparent url('takeoverMJB/EMF_PromoPage_MJB_officiallink.gif') no-repeat scroll left top; display:block; width:146px; height:25px; color:#ffffff; font-size:12px; padding-top:5px; padding-left:20px; margin-left:65px; text-decoration:none;}
...
<td valign="top">
	<div class="promobox">		
		<div class="right wid-600" style="padding-top:155px; padding-right:10px;">			
			...
			Check out the new Essence Music Festival Twitter Promotion featuring Mary J. Blige. For 25 lucky winners, Essence Music Festival is giving away a special limited edition signed photograph of Mary J. Blige. The only catch is that you have to spread the word, social networking-style.
			<br/><br/>
			To enter for a chance to win, all you need is a Twitter account and a willingness to re-tweet. First, follow <a href="http://twitter.com/essencemusic">@essencemusic.</a> Then, keep an eye out for the following tweet: "For a chance 2 win a signed photo of Mary J. Blige, RT #EMF2010, I want to see Mary J. Blige,<a href="http://bit.ly/emfmjbtweet">http://bit.ly/emfmjbtweet</a>". Once you see that, simply re-tweet it and you're all set. Simple, right?
			<br/><br/>
			The sweepstakes starts today June 8, 2010 and will run through June 9, 2010 ending at 11pm EST. The winners will be announced at the essencemusic twitter feed and posted on the EMF website. Good luck!			
			</div>			
			<div class="clearout"></div>
			<div class="left pad-top-30"><a href="http://www.mjblige.com/"><img src="takeoverMJB/MJB_button.png" alt="Mary J Blige Logo" border="0"></a></div>
			<div class="left pad-top-30"><a href="http://www.ffawn.org/"><img src="takeoverMJB/fawn_button.png" alt="FFawn Logo" border="0"></a></div>
			<div class="right pad-top-30" style="margin-right:15px;"><a href="http://www.facebook.com/pages/Essence-Online/68771922854#!/pages/ESSENCE-Music-Festival/42125257610?ref=sgm"><img src="takeoverMJB/facebook-icon.png" alt="facebook" border="0"></a></div>
			<div class="right pad-top-30" style="margin-right:10px;"><a href="http://twitter.com/essencemusic"><img src="takeoverMJB/twitter-icon.png" alt="twitter" border="0"></a></div>
			...
			<div class="right pad-top-30" style="margin-right:5px;"><iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.essencemusicfestival.com%2Fmaryjbligetwitter.php&amp;layout=button_count&amp;show_faces=true&amp;width=120&amp;action=like&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:90px; height:21px;" allowTransparency="true"></iframe></div>
		</div>
	</div>
	<div class="clearout"></div>
	<a href="maryjblige_twitterpromotion_rules.php" title="Official Rules" id="showrules" class="left" target="_blank"><strong>The Official Rules &gt;</strong></a>
</td>
</tr>
