...
<td width="248" valign="top" align="left"><img src="shim.gif" width="200" height="8">
<img src="bar1.gif">
...
<object width="764" height="368"><param name="movie" value="emfArtistScroll.swf"></param><param name="wmode" value="transparent"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="emfArtistScroll.swf" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="764" height="368" wmode="transparent"></embed></object>
...
<td valign="top"><img src="shim.gif" width="10" height="400" align="left"></td>
<td valign="top">
