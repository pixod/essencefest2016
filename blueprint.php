...
.promobox{ background:transparent url('takeoverKirkFranklin/background.jpg') no-repeat scroll left top;  margin:10px auto 0px auto; padding:17px 18px 0px 18px; width:976px; height:471px; color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:14px;}
...
#showrules{ background:transparent url('takeoverKirkFranklin/officiallink.gif') no-repeat scroll left top; display:block; width:146px; height:25px; color:#ffffff; font-size:12px; padding-top:5px; padding-left:15px; margin-left:65px; text-decoration:none;}
...
<td valign="top">
	<div class="promobox">		
		<div class="right wid-650" style="padding-top:135px; padding-right:10px;">			
			<div style="text-align:left; height:255px;">
			Catch the inspirational messages from Kirk Franklin's new Book - The Blueprint…<br/><br/>
			Check out the new Essence Music Twitter Promotion featuring The Seven-Time Grammy Award Winning Artist Kirk Franklin's New Book, "A 
			Plan for Living Above Life's Storms". For 3 lucky winners, Essence Music Festival and Kirk Franklin is giving away a special limited number of autographed copies.People, the only catch in order to win, is that you have to spread the word, social media networking style.
			<br/><br/>
			
			To enter for a chance to win, all you need is a Twitter account and a willingness to re-tweet. First, follow <a href="http://twitter.com/essencemusic">@essencemusic.</a> Then, keep an eye out for the inspirational tweet: “Pursue your dreams without losing yourself in the chase. #EMF2010 <a href="http://bit.ly/dmKpOQ">http://bit.ly/dmKpOQ</a>". Once you see that, simply re-tweet it and you're all set. Simple, right?
			<br/><br/>
			
			The sweepstakes starts today at 2pm EST, June 30th 2010 and will run through at 
				12pm EST July 2nd ending. The winners will be announced at the essencemusic twitter feed and posted on the EMF website. Good Luck!
			</div>			
		</div>
		...
		<div class="left wid-950" style="padding-right:10px;">
			...
			<div class="right pad-top-30" style="margin-right:15px;"><a href="http://www.facebook.com/pages/Essence-Online/68771922854#!/pages/ESSENCE-Music-Festival/42125257610?ref=sgm" target="_blank"><img src="takeoverKirkFranklin/facebook-icon.png" alt="facebook" border="0"></a></div>
			<div class="right pad-top-30" style="margin-right:10px;"><a href="http://twitter.com/essencemusic" target="_blank"><img src="takeoverKirkFranklin/twitter-icon.png" alt="twitter" border="0"></a></div>
			...
			<div class="right pad-top-30" style="margin-right:5px;"><iframe src="http://www.facebook.com/plugins/like.php?href=www.essencemusicfestival.com%2Fblueprint.php&amp;layout=button_count&amp;show_faces=true&amp;width=90&amp;action=like&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:90px; height:21px;" allowTransparency="true"></iframe></div>				
		</div>
	</div>
	<div class="clearout"></div>
	<a href="blueprint_rules.php" title="Official Rules" id="showrules" class="left" target="_blank"><strong>The Official Rules &gt;</strong></a>
</td>
</tr>
