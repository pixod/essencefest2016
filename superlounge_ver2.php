...
<head> 
	<title>Essence Music Festival 2010 | SuperLounge</title>
...
.block{ width:790px;  height:380px; margin:0px 0px 25px 0px;  display:block;}
.block a img{border:none;}

.block .top{ background:transparent url('lounge_block_tilte.png') no-repeat scroll left top; display:block; padding:40px 0px 0px 65px; height:154px;}
.block .bottom{ background:#e65f57 url('lounge_block.gif') no-repeat scroll left bottom; display:block; padding:35px 0px 10px 20px; width:746px;}
...
/*.date-grid-sep{ background:transparent url('lounge_block_grid_divider.jpg') no-repeat scroll right bottom;}*/

.datetitle{ font-size:25px; color:#FFFFFF; font-weight:bold;}

.artistspan{float:left; padding:0px 15px 0px 0px; width:100px; }
.artistspan a{color:#d02239; text-decoration:none; font-weight:bold;}
...
<script type="text/javascript">
	...
	*/
	...
	swfobject.embedSWF(swf, "inline", "420", "297", "9.0.28", "expressInstall.swf", flashVars, params, attributes);
	...
	*/
	...
	swfobject.embedSWF(swf, "playlist", "460", "300", "9.0.28", "expressInstall.swf", flashVars, params, attributes);
...
<tr>
	<td colspan="3">	
		<div style="border-bottom:15px solid #b22545; margin-bottom:10px; background:transparent url('superloungeStrip.png') repeat-x scroll left bottom;">
			<span style="padding:15px 0px 0px 65px; display:block;"><img src="superlougetitle.png"></span>
			<br/>
			
			<div style="float:right; padding:0px 90px 20px 0px;">
			<!--video CONTENT -->
...
<div class="block">
<div class="top">
	<img alt="coca-cola" height="103" src="LOGO_Coca.png" width="300">
</div>
<div class="clearout"></div>
<div class="bottom">
	<div class="date-grid">
		...
		<div class="content"><span class="artistspan"><a href="marymary.php"><img alt="marymary" height="79" src="emfArtists/marymary.jpg" width="80">Mary Mary</a></span><span class="artistspan"><a href="irvinmayfield.php"><img height="79" src="emfArtists/IrvinMayfield.jpg" width="80">Irvin Mayfield and The New Orleans Jazz Orchestra</a></span></div></h2>
	</div>
	<div class="date-grid">
		<h2><span class="datetitle">SATURDAY, JULY 3</span>
		<div class="content"><span class="artistspan"><a href="joe.php"><img alt="joe" height="79" src="emfArtists/joe.jpg" width="80">Joe</a></span><span class="artistspan"><a href="rebirthbrassband.php"><img alt="rebirthbrassband" height="79" src="emfArtists/RebirthBrass.jpg" width="80">Rebirth Brass Band</a></span></div></h2>
	</div>
	<div class="date-grid">
		<h2>
		<span class="datetitle">SUNDAY, JULY 4</span>
		<div class="content"><span class="artistspan"><a href="lalahhathaway.php"><img alt="lalah" height="79" src="emfArtists/LalahHathaway.jpg" width="80">Lalah Hathaway</a></span><span class="artistspan"><a href="dumpstaphunk.php"><img alt="dumpstaphunk" height="79" src="emfArtists/dumpstaphunk.jpg" width="80">Ivan Neville's <br/>Dumpstaphunk</a></span></div></h2>
	</div>
<div class="clearout"></div>	
</div>
</div>
...
<div  class="block">
<div class="top">
	<img alt="mcdonalds" src="LOGO_McDonald.png" height="103" width="113">
</div>	
<div class="clearout"></div>
<div class="bottom">
	<div class="date-grid">
...
<div  class="block">
<div class="top">
	<img alt="my black is beatiful" src="myblackisbeautiful_logo.png" height="103" width="125">
</div>	
<div class="clearout"></div>
<div class="bottom">
	<div class="date-grid">
...
<div  class="block">
<div class="top">
	<img alt="lincoln" src="lincoln_logo_v3.png" height="103" width="163">
</div>	
<div class="clearout"></div>
<div class="bottom">
	<div class="date-grid">
